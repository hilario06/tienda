...
ActiveRecord::Schema.define(version: 2022_06_12_154749) do
  ...
  create_table "charges", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shopping_cart_id"], name: "index_charges_on_shopping_cart_id"
  ...
  add_foreign_key "charges", "shopping_carts"
